                ...
                <div id="personalDetails">
                  ...
                  <div class="form-row">
                    ...
                    <div class="form-group col-md-5">
                      ...
                      <input type="text" value="<?= $student->initials_name; ?>" id="initials_name" name="initials_name" class="form-control form-control-sm" placeholder="R.A.I.S. RANASINGHE" required>
                    </div>
                    <div class="form-group col-md-6">
                      <label>Full Name <span class="required">*</span></label>
                      <input type="text" value="<?= $student->full_name; ?>" id="full_name" name="full_name" class="form-control form-control-sm" placeholder="RANASINGHE ARACHCHIGE ISURU SANDEEPA RANASINGHE" required>
                    </div>
                    <div class="form-group col-md-3">
                      <label>Date of Birth <span class="required">*</span></label>
                      <input type="text" value="<?= $student->dob; ?>" id="dob" name="dob" class="form-control form-control-sm" placeholder="1997-12-22" required>
                    </div>
                    <div class="form-group col-md-3">
                    ...
                    <div class="form-group col-md-3">
                      ...
                      <input type="text" value="<?= $student->nic; ?>" id="nic" name="nic" class="form-control form-control-sm" placeholder="974671480V" required>
                      <div class="validation-feedback" id="nic_validation"></div>
                    </div>
                    <div class="form-group col-md-3">
                      <label>Nationality <span class="required">*</span></label>
                      <input type="text" value="<?= $student->nationality; ?>" id="nationality" name="nationality" class="form-control form-control-sm" placeholder="SRI LANKAN" required>
                    </div>
                    <div class="form-group col-md-6">
                      <label>Address <span class="required">*</span></label>
                      <input type="text" value="<?= $student->address; ?>" id="address" value="<?php if(!empty($inquiry_details)) { echo $inquiry_details['address']; } ?>" name="address" class="form-control form-control-sm" placeholder="3A/228, HOUSINGHE SCHEME" required>
                    </div>
                    <div class="form-group col-md-3">
                      <label>City <span class="required">*</span></label>
                      <input type="text" id="city" value="<?= $student->city; ?>" name="city" class="form-control form-control-sm" placeholder="NUGEGODA" required>
                    </div>
                    <div class="form-group col-md-3">
                    ...
                    <div class="form-group col-md-3">
                      ...
                      <input type="text" value="0<?= $student->mobile; ?>" id="mobile" name="mobile" class="form-control form-control-sm" placeholder="0770430000" required>
                      <div class="validation-feedback" id="mobile_validation"></div>
                    </div>
                    <div class="form-group col-md-3">
                      <label>Home Number <span class="required">*</span></label>
                      <input type="text" id="home" value="0<?= $student->home; ?>" name="home" class="form-control form-control-sm" placeholder="0117430000" required>
                      <div class="validation-feedback" id="home_validation"></div>
                    </div>
                    <div class="form-group col-md-6">
                      <label>Email <span class="required">*</span></label>
                      <input type="email" id="email" value="<?= $student->email; ?>" name="email" class="form-control form-control-sm" placeholder="info@saegis.edu.lk" required>
                    </div>
                  </div>
                  <hr>
                </div>
                ...
                <div id="educationDetails">
                  ...
                  <div class="form-row">
                    ...
                    <div class="form-group col-md-4">
                      ...
                      <input type="text" value="<?= $student->ol; ?>" id="ol" name="ol" class="form-control form-control-sm" placeholder="7A, 2B" required>
                    </div>
                    <div class="form-group col-md-2">
                      <label>Year <span class="required">*</span></label>
                      <input type="text" value="<?= $student->ol_year; ?>" id="ol_year" name="ol_year" class="form-control form-control-sm" placeholder="2013" required>
                    </div>
                    <div class="form-group col-md-2">
                      <label>G.C.E. A/L <span class="required">*</span></label>
                      <input type="text" value="<?= $student->al; ?>" id="al" name="al" class="form-control form-control-sm" placeholder="1A, 2B" required>
                    </div>
                    <div class="form-group col-md-2">
                      <label>Stream <span class="required">*</span></label>
                      <select id="stream" name="stream" class="form-control form-control-sm" required>
                        <option value="<?= $student->stream; ?>"><?= $student->stream; ?></option>
                    ...
                    <div class="form-group col-md-2">
                      <label>Year <span class="required">*</span></label>
                      <input type="text" value="<?= $student->al_year; ?>" id="al_year" name="al_year" class="form-control form-control-sm" placeholder="2016" required>
                    </div>
                    <div class="form-group col-md-12">
                      <label>Other Educational Qualifications</label>
                      <textarea class="form-control" value="<?= $student->other_edu; ?>" name="other_edu" id="other_edu">
                      </textarea>
                    </div>
                  </div>
                  <hr>
                ...
                <div id="guardianDetails">
                  ...
                  <div class="form-row">
                    <div class="form-group col-md-3">
                      ...
                      <input type="text" value="<?= $student->guardian_name; ?>" id="guardian_name" name="guardian_name" class="form-control form-control-sm" placeholder="R.A.RANASINGHE" required>
                    </div>
                    <div class="form-group col-md-3">
                      <label>Relationship <span class="required">*</span></label>
                      <input type="text" value="<?= $student->relationship; ?>" id="relationship" name="relationship" class="form-control form-control-sm" placeholder="FATHER" required>
                    </div>
                    <div class="form-group col-md-3">
                      <label>Mobile Number <span class="required">*</span></label>
                      <input type="text" value="<?= $student->guardian_mobile; ?>" id="guardian_mobile" name="guardian_mobile" class="form-control form-control-sm" placeholder="0770430000" required>
                      <div class="validation-feedback" id="guardian_validation"></div>
                    </div>
                    <div class="form-group col-md-3">
                      <label>Home Number</label>
                      <input type="text" value="<?= $student->guardian_home; ?>" id="guardian_home" name="guardian_home" class="form-control form-control-sm" placeholder="0117430000">
                    </div>
                  </div>
                  ...
                  <div class="form-row">
                    ...
                    <div class="form-group col-md-1">
                      ...
                      <input type="text" value="<?= $student->studentId; ?>" id="studentId" name="studentId" class="form-control form-control-sm" readonly>
                    </div>
                    <div class="form-group col-md-2">
                    ...
                    <div class="form-group col-md-12">
                      <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="1" name="birth_certificate" id="birth_certificate" <?php if($student->birth_certificate==1) { echo "checked"; } ?>>
                        <label class="form-check-label" for="invalidCheck2">
                          Birth Certificate
                        </label>
                      </div>
                      <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="1" name="ol_certificate" id="ol_certificate" <?php if($student->ol_certificate==1) { echo "checked"; } ?>>
                        <label class="form-check-label" for="invalidCheck2">
                          G.C.E. O/L Certificate
                        </label>
                      </div>
                      <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="1" name="al_certificate" id="al_certificate" <?php if($student->al_certificate==1) { echo "checked"; } ?>>
                        <label class="form-check-label" for="invalidCheck2">
                          G.C.E. A/L Certificate
                        </label>
                      </div>
                      <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="1" name="nic_copy" id="nic_copy" <?php if($student->nic_copy==1) { echo "checked"; } ?>>
                        <label class="form-check-label" for="invalidCheck2">
                          A Copy of National ID Card / Passport
                        </label>
                      </div>
                      <div class="form-check">
                        <input class="form-check-input" type="checkbox" value="1" name="other_certificates" id="other_certificates" <?php if($student->other_certificates==1) { echo "checked"; } ?>>
                        <label class="form-check-label" for="invalidCheck2">
